...
for gen in range(1, max_iter + 1):
    ...
    if gen % max_converge == 0:
        print(f"Gen: {gen}, best_fitness: {(num_task - f_best[0], f_best[1], f_best[2])}, current_fitness: {(num_task - f_curr[0], f_curr[1], f_curr[2])}")
        
print('------------------------')
print(f"Simple Hill Climbing")
